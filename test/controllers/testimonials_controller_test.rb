...
class TestimonialsControllerTest < ActionController::TestCase
  ...
  test "should create testimonial" do
    assert_difference('Testimonial.count') do
      post :create, testimonial: { body: @testimonial.body, name: @testimonial.name, profession: @testimonial.profession }
    end
  ...
  test "should update testimonial" do
    patch :update, id: @testimonial, testimonial: { body: @testimonial.body, name: @testimonial.name, profession: @testimonial.profession }
    assert_redirected_to testimonial_path(assigns(:testimonial))
  end
