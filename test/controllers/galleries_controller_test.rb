...
class GalleriesControllerTest < ActionController::TestCase
  ...
  test "should create gallery" do
    assert_difference('Gallery.count') do
      post :create, gallery: { body: @gallery.body, event_date: @gallery.event_date, rank: @gallery.rank, title: @gallery.title }
    end
  ...
  test "should update gallery" do
    patch :update, id: @gallery, gallery: { body: @gallery.body, event_date: @gallery.event_date, rank: @gallery.rank, title: @gallery.title }
    assert_redirected_to gallery_path(assigns(:gallery))
  end
