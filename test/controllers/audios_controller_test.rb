...
class AudiosControllerTest < ActionController::TestCase
  ...
  test "should create audio" do
    assert_difference('Audio.count') do
      post :create, audio: { body: @audio.body, category_id: @audio.category_id, highlight: @audio.highlight, rank: @audio.rank, title: @audio.title, url: @audio.url }
    end
  ...
  test "should update audio" do
    patch :update, id: @audio, audio: { body: @audio.body, category_id: @audio.category_id, highlight: @audio.highlight, rank: @audio.rank, title: @audio.title, url: @audio.url }
    assert_redirected_to audio_path(assigns(:audio))
  end
